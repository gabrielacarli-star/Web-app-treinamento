...
export default async function ResetPasswordPage({
  ...
  // Reaching this page requires the session the invite/recovery link's code
  // exchange set up in /auth/callback — no session means the link was
  // already used, expired, or never valid to begin with.
